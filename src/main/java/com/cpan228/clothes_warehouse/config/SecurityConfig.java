...
//  IMPORTANT: Spring Security automatically adds the "ROLE_" prefix to role names when checking authorities
        http
                ...
                .requestMatchers("/add", "/itemlist", "/add/deleteAllItems", "/dc", "/itemlist/switchPage", "/dc/centres", "/itemlist/search-item-2").hasRole("ADMIN")
                .requestMatchers("/add", "/itemlist","/itemlist/switchPage", "/itemlist/search-item", "/itemlist/search-item-2").hasRole("WAREHOUSE")
